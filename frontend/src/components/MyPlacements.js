          ...
          <main>
            <div className="container">
              <div className="content mt-3 mb-1 border border-dark">
                <div className="m-3">
                  <h1 className="text-white h1_font">Мои размещения</h1>
                ...
                <div className="ml-3">
                  <ul class="nav nav-pills subj_font mt-2">
                    <li class="nav-item">
                      <a class="nav-link my_rounded mr-2 mt-1 py-0 border border-dark active" href="#">Активные</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="col-md-9 col-12 order-2 order-md-1">
                      <div class="card border border-dark my_rounded card_order">
                        ...
                        <div class="d-grid gap-2">
                          <button class="bg_button btn width_button my_rounded mx-3 py-0 my-1 bg_button border border-white" type="button">Закрыть</button>
                        </div>
                      </div>
                    </div>
